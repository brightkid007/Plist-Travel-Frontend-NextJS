...
import go from "/public/Images/Group 281.png";
...
function Four6() {
  return (
    <div className="lg:w-[90%] lg:mx-auto">
      <div>
        <h4 className="border border-[#054CA3] text-[#054CA3] text-center w-fit mx-auto rounded-full lg:mt-16 mt-10 text-sm sm:text-base font-Bricolage text-[18px] font-bold py-[10px] px-[12px]">
          CONVINENT BOOKING
        </h4>
      ...
      <div className="flex md:gap-10 gap-5 lg:ms-52 lg:justify-center ms-0 mt-10 lg:flex-row flex-col lg:px-0 px-3">
        <div>
          <Image src={go} alt="" className="h-full max-[1024px]:w-full" />
        </div>
        <div className="flex flex-col gap-6 lg:w-auto w-[100%]">
          <div className="bg-[#DAECF0] h-[244px] lg:w-[80%] xl:w-[75%] px-9 py-7 w-full rounded-xl">
          ...
          <div className="bg-[#DAECF0] lg:w-[80%] xl:w-[75%] h-[244px] w-[100%] px-9 py-7 rounded-xl">
            <div className="flex flex-col">
              <Image src={colorSquare} alt="colorSquare" />
              <h1 className="text-[24px] font-medium text-[#11161F] font-Bricolage mt-2">

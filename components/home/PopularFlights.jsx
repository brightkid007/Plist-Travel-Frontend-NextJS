...
import flightsData from "@/components/data/popularFlightsData";
              ...
              >
                <div className="cruiseCard__image position-relative">
                  <div className="carCard__image">
                    <div className="cardImage ratio ratio-6:5 rounded-22">
                  ...
                  <div className="cardImage__leftBadge">
                    <div
                      className={`py-5 px-15 rounded-right-4 text-12 lh-16 fw-500 uppercase ${
                        isTextMatched(item?.tag, "One Way")
                          ? "bg-dark-1 text-white"
                          : ""
                      } ${
                        isTextMatched(item?.tag, "Round Trip")
                          ? "bg-blue-1 text-white"
                          : ""
                      }  ${
                        isTextMatched(item?.tag, "Multi City")

...
import bgImage from "/public/Images/Group-265.png";
...
function Third3() {
  return (
    <div
      ...
      style={{ backgroundImage: `url("/Images/Group-265.png")` }}
    >
      <div>
      ...
      <div className="other3-BG w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[496px] lg:h-[496px] rounded-full text-center flex flex-col justify-center items-center px-4">
        ...
        <button className="text-[16px] font-medium text-[#054CA3] font-Bricolage py-[12px] px-[16px] bg-white rounded-[8px] mt-4 cursor-pointer">
          Find Deals
        </button>
      </div>
    </div>

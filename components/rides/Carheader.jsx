...
function Carheader() {
  ...
  return (
    <>
      <div className="bg-[#7964D8] md:h-[83px] h-[60px] text-white xl:px-44 lg:px-16 lg:text-lg text-xs">
      ...
      <div
        style={{
          backgroundImage: `url("/Images/Group-283.png")`,
      ...
      >
        ...
        <div className="lg:pt-6 pt-3 xl:px-44 lg:px-16 px-4">
          <div className="flex justify-center lg:justify-between items-center mt-3">
            ...
            <div className="absolute right-5lg:hidden">
              <button

...
function Holi5() {
  return (
    <div className="flex justify-center lg:mt-44 mt-16">
      <div className="bg-[#054CA3] lg:w-full w-[96%] text-center lg:text-start lg:h-[437px] h-auto md:p-10  px-5 py-5 rounded-xl flex lg:justify-center gap-5 lg:flex-row flex-col lg:items-start items-center">

...
const ProfileDetail = () => {
    ...
    return (
        <>
            ...
            <div className="col-lg-12 col-md-6 col-sm-6 mt-30 border-light rounded-8 bg-white shadow-3 px-15 py-15">
                
                <div className="d-flex justify-between">
                <SavedBookingCard name={'The Montcalm At Brewery London'} location={'London, UK'} image={'/img/destinations/1/1.png'} />
                <SavedBookingCard name={'Staycity Aparthotels'} location={'Barcelona, Spain'} image={'/img/destinations/1/1.png'} />
                </div>

...
import flogo from "/public/Images/whiteLogo.png";
import icons from "/public/Images/Screenshot_4 1.png";
import pay from "/public/Images/Group 257.png";
...
function Footer() {
  return (
    <div
      className="flex flex-col items-center justify-center text-white mt-10 lg:mt-28 bg-no-repeat bg-cover"
      ...
      <div className="lg:w-[80%] w-[100%] lg:text-start text-center flex gap-10 sm:mt-20 mt-10 lg:flex-row flex-col">
        ...
        <div className="lg:block hidden">
          <div className="w-full">
            <h3 className="text-[15px] font-bold font-Bricolage">
              Payments Methods
            </h3>
          </div>

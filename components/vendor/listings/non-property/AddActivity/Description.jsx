  ...
  return (
    <div className="row y-gap-10 x-gap-10">
      ...
      <div className="col-sm-6 mt-5">
        <h1 className="text-14 lh-12 fw-500">Activity Name <span className="text-red-1">*</span></h1>
        <input
      ...
      <div className="col-sm-6 mt-5">
        <h1 className="text-14 lh-12 fw-500">Activity Category <span className="text-red-1">*</span></h1>
        <select
      ...
      <div className="col-sm-6 mt-5">
        <h1 className="text-14 lh-12 fw-500">Activity Subcategory <span className="text-red-1">*</span></h1>
        <select
          className="form-select rounded-8 border-light px-15 py-10 justify-between text-14 w-full mt-10"
      ...
      <div className="col-sm-12 mt-5">
        <h1 className="text-14 lh-12 fw-500">Activity Description</h1>
        <textarea
          rows={5}
          className="border-light rounded-8 py-5 px-15 w-full mt-10"
          type="text"

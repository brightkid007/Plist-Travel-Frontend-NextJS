...
const ListingDetails = ({ 
  ...
  const whatToBring = data?.what_to_bring || "";
  ...
  const instructorHostName = data?.instructor_host_name || "";
  const instructorHostDetail = data?.instructor_host_detail || "";
    ...
    <div className="row y-gap-10 x-gap-10">
      ...
      <div className="col-sm-6 mt-5">
        ...
        <input
          ...
          value={whatToBring}
          onChange={(e) => handleFieldChange("what_to_bring", e.target.value)}
        />
      </div>
      ...
      <div className="col-sm-6 mt-5">
        ...
        <input
          ...
          value={instructorHostName}
          onChange={(e) => handleFieldChange("instructor_host_name", e.target.value)}
        />
      </div>
      ...
      <div className="col-sm-6 mt-5">
        ...
        <input
          ...
          value={instructorHostDetail}
          onChange={(e) => handleFieldChange("instructor_host_detail", e.target.value)}
        />
      </div>

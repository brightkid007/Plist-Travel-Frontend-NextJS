...
import { featuredDestination } from "@/components/data/featuredDestinationsData";
...
const SimilarProperties = () => {
  return (
    <>
      ...
      >
        {featuredDestination.slice(0, 9).map((item) => (
          <SwiperSlide key={item?.id}>
            <Link
              href={"/customer/property/1"}
              className="hotelsCard -type-1 hover-inside-slider"
              data-aos="fade"
              data-aos-delay={item.delayAnimation}
            >
              <div className="hotelsCard__image shadow">
              ...
              <div className="hotelsCard__content mt-10">
                ...
                <div className="d-flex items-center mt-20">
                  <div className="flex-center bg-info rounded-4 size-30 text-10 fw-600 text-white">
                    {item?.ratings}
                  </div>

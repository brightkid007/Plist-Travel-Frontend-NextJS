...
export const ServiceDetail = () => {
  ...
  const categoryList = [
    { label: "Flight", content: <FlightDetails /> },
    { label: "Hotel", content: <HotelDetails /> },
    { label: "Transportation", content: <TransportationDetails /> },
    { label: "Tours", content: <ToursDetails /> },
    { label: "Activities", content: <ActivitiesDetails /> },
  ];

  return (
    <>
      <div className="row y-gap-20 py-30 px-30 rounded-8 bg-white shadow-3">
        <h1 className="text-20 lh-14 fw-600">Flight Details</h1>
        <div className="col-12 row y-gap-10">
          {categoryList.map((item, index) => (
            <div
              key={index}
              class={
                "col-auto py-5 px-15 rounded-16 text-10 lh-16 fw-500 uppercase mr-10 mb-20 " +
...
const FlightDetails = () => {
  ...
  return (
    <>
      ...
      <div className="col-12 row y-gap-10 px-30">
        <div className="col-6">
...
const TransportationDetails = () => {
  return <h1>Transportation Details</h1>;
};

const ToursDetails = () => {
  return <h1>Tours Details</h1>;
};

const ActivitiesDetails = () => {
  return <h1>Activities Details</h1>;
};

...
import bgImg from "/public/Images/Group-284.png";
import boob from "/public/Images/7197353 1.png";
import Image from "next/image";

function Car3() {
  return (
    <div
      className="bg-cover bg-center bg-no-repeat lg:h-[613px] h-auto flex items-center justify-center text-white text-4xl font-bold mt-20"
      style={{ backgroundImage: `url("/Images/Group-284.png")` }}
    >

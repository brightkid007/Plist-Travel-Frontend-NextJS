...
function Car4() {
  return (
    <div className="px-4 md:px-10 lg:px-32 py-10 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:mt-10 mt-5 lg:w-[83%] mx-auto lg:gap-16">
      {/* First Box */}
      <div
        style={{
          backgroundImage: `url("/Images/Group-106-(1).png")`,
      ...
      <div
        style={{
          backgroundImage: `url("/Images/Group-106-(2).png")`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
        className="relative w-full h-[300px] lg:h-[390px] rounded-[12px] flex items-center justify-center"

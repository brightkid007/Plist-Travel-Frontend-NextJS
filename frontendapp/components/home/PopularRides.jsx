...
import carsData from "@/components/data/ridesData";
          ...
          <SwiperSlide key={item.id}>
            ...
            >
              <Link
                ...
                className="carCard -type-1 d-block hover-inside-slider"
              >
                <div className="carCard__image">
                  <div className="cardImage ratio border-light ratio-16:9 rounded-22">

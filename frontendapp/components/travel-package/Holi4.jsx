...
function Holi4() {
  return (
    <div className="lg:w-[70%] lg:mx-auto">
      ...
      <div className="flex gap-5 lg:justify-center ms-0 mt-10 lg:flex-row flex-col lg:px-0 px-3 w-full">
        <div className=" lg:w-[50%] lg:mx-auto">
          <Image src={go} alt="" className="h-full max-[1024px]:w-full" />
        </div>
        <div className="flex flex-col gap-6 lg:w-[50%]">
          <div className="bg-[#DAECF0] h-[244px] px-9 py-7 w-full rounded-xl">
          ...
          <div className="bg-[#DAECF0] h-[244px] w-[100%] px-9 py-7 rounded-xl">
            <div className="flex flex-col">
              <Image src={colorSquare} alt="colorSquare" />
              <h1 className="text-[24px] font-medium text-[#11161F] font-Bricolage mt-2">
